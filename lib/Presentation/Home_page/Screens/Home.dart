...
import 'package:complete_e_commerce_app/Presentation/Home_page/Search_Function/SearchFunction.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        //   items: [
        //     Icon(Icons.home_outlined,color: text2,),
        //     Icon(Icons.shopping_cart_outlined,color: text2,),
        //     Icon(Icons.favorite_outline,color: text2,),
        //   ],
        //   onTap: (index) {
        //
        //   },
        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              BlocBuilder<HomeCubit, HomeState>(builder: (context, state) {
                final categories = cubit.categoriemodelData.data?.data;
                        ...
                        return Column(
                          children: [
                            Container(
                              ...
                              width: 80,
                              child:
                              Image.network(categories?[index].image ?? "",fit: BoxFit.cover,),
                            ),
